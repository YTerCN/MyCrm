...
<script type="text/javascript">
	$(function(){
		...
		$("#addBtn").click(function () {
			$("#activity").val($("#"+$(":radio[name=activity]:checked").val()).html());
			$("#activityId").val($(":radio[name=activity]:checked").val());
			$("#searchActivity").val("");
			$("#activityBody").empty();
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form action="workbench/clue/convert.do" id="tranForm" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" name="name" id="tradeName">
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    <label for="activity">市场活动源&nbsp;&nbsp;<a href="javascript:void(0);" id="addActivity" style="text-decoration: none;"><span class="glyphicon glyphicon-search"></span></a></label>
